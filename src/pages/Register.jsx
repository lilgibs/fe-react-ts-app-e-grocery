...
const Register = () => {
  ...
  const registerUser = async (data) => {
    try {
      setIsLoading(true);
      setIsDisabled(true);
      let response = await Axios.post("http://localhost:8000/api/auth/register", data);
      if (response) {
  ...
  return (
    <div className="flex flex-row items-start justify-around m-8">
      <div className="flex-initial w-96 max-md:hidden">
        <img src="https://freepngimg.com/thumb/ecommerce/1-2-ecommerce-png.png" alt="" className="" />
      </div>
